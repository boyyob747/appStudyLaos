package com.bounthavong.vithaya.hoctienglao.fragments.adapter.listener;
...
public class LAOTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    public LAOTouchListener(Context context, final RecyclerView recyclerView,
